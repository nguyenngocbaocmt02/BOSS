...
class NCSNpp(nn.Module):
  ...
  def __init__(self, config):
    ...
    if embedding_type == 'fourier':
      ...
      assert config.training.sde == 'redress_flow' or config.training.continuous or config.training.sde=='rectified_flow', "Fourier features are only used for continuous training."
